...
; Всегда меняются
#define GameName "King Arthur Fallen Champions"                                          ; Название игры
#define GameNameDash "King-Arthur-Fallen-Champions"                                                          ; Название игры без пробелов
#define GameNameEXE "FallenChampions"                                                              ; Название exe файла игры
#define GameVer "1.0"                                                                     ; Версия игры
#define GameAppIdSteam "24460"                                                             ; Ид игры в стиме
; От ситуации зависит
...
[Setup]
;Номер приложения для его удаление лучше все время не забывать разный совать. Проверка уникальный для: King Arthur - Fallen Champions Fix
AppId={{6EE146E0-98E7-4300-8DE0-B08F2275ADE9}
...
Source: {#Location}\{#GameName}\main\*; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Root:HKCU;Subkey:SOFTWARE\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers;ValueType: string; ValueName:{app}\FallenChampions.exe;ValueData:RUNASADMIN
...
[CustomMessages]
english.Fix=Fix crashes
russian.Fix=Фикс вылетов
